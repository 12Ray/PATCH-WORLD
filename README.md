...
- 배경과 충돌 지형이 정렬된 9개의 1920×1080 탐험 방, 지역 보스 아레나와 1920×1080 최종 보스 맵
...
에셋 누락과 런타임 연결은 별도 회귀 테스트로 검사합니다. 캠페인 배경, 적 15종의 전투·Art v3·투사체 아틀라스와 최종 보스 프레임은 타이틀 화면에서 비동기 사전 로딩합니다. 현재 저장소는 총 254개의 자동화 테스트를 포함합니다.
...
- 배경 발판과 실제 충돌 지형 정렬, 수직 카메라 추적과 세 무기 공통 필수 경로: 완료
...
- 자동화 테스트 254개, 3개 언어 핵심 UI 오버플로와 지역별 체크포인트 재시작 회귀: 통과
...
- 9개 탐험 배경을 품질 88 WebP로 최적화: 웹 전체 82.50/90 MiB, 게임 에셋 39.37/42 MiB 예산 통과

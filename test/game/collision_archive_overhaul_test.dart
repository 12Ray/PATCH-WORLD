...
void main() {
  ...
  testWidgets('Collision Archive has three cells, quest, and dedicated boss', (
    tester,
  ) async {
    await expectLaterChapterOverhaul(
      tester,
      roomId: RoomId.collisionArchive,
      bossKind: CampaignChapterBossKind.kernelChimera,
      questItem: RunItemId.vectorBoots,
      bossItem: RunItemId.collisionPrism,
    );
  });
}
